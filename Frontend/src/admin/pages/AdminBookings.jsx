...
import { FiSlash, FiUserCheck, FiTrash2, FiCheckCircle, FiAlertCircle, FiAlertTriangle, FiX, FiBookmark, FiInfo, FiMapPin, FiHome, FiUser } from "react-icons/fi";
        ...
        <div style={cs.overlay} onClick={() => setSelected(null)}>
          <div style={cs.modal} onClick={(e) => e.stopPropagation()}>
            <div style={cs.modalHeader}>
              ...
              <button style={cs.modalCloseBtn} onClick={() => setSelected(null)}><FiX size={18} /></button>
            </div>
...
const cs = {
  ...
  modalCloseBtn: { background: "none", border: "none", cursor: "pointer", color: "#888", display: "flex" },
